...
v_Pop2 = []
P2_adresses = ["anonimized_data_user_2_phone_2_2.csv", "anonimized_data_user_1_phone_4.csv",
               "anonimized_data_user_2_phone_4.csv", "anonimized_data_user_3_phone_2.csv",
               "anonimized_data_user_3_phone_3.csv", "anonimized_data_user_4_phone_2.csv",
               "anonimized_data_user_4_phone_3.csv", "anonimized_data_user_5_phone_1_1.csv",
               "anonimized_data_user_5_phone_1_2.csv", "anonimized_data_user_6_phone_4.csv",
    ...
    for l in range(40):
        ...
        for i in temp:
            for j in range(len(adapted)):
                adapted[j].append(i[j])
        plt.scatter([l]*N_Pop2, adapted[l][N_Pop1:], c='dimgray', label="P2", s=10)
        plt.scatter([l] * N_Pop1, adapted[l][:N_Pop1], c='darkgray', label="P1", s=10)
